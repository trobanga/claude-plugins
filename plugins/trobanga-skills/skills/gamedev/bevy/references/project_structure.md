...
Bevy 0.18 introduces collection features for simplified dependency management:

```toml
[dependencies]
# Instead of listing individual features, use collections:
...
This reduces boilerplate in `Cargo.toml` for common project types.
